...
```bash
pip uninstall table_of_contents
```
...
# Change directory to the table_of_contents directory
...
folder is located. Then you can remove the symlink named `table_of_contents` within that folder.
